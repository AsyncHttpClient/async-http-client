...
public class NettyResponseFutureTest {
    ...
    public void testCancel() {
        ...
        assertTrue(nettyResponseFuture.isCancelled(), "isCancelled should returned true for a canclled Future");
    }
    ...
    public void testCancelOnAlreadyCancelled() {
        ...
        assertTrue(nettyResponseFuture.isCancelled(), "isCancelled should returned true for a cancelled Future");
    }
