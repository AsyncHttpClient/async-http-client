 ...
 */
package org.asynchttpclient.extras.rxjava3;
...
import org.asynchttpclient.extras.rxjava3.maybe.MaybeAsyncHandlerBridge;
import org.asynchttpclient.extras.rxjava3.maybe.ProgressAsyncMaybeEmitterBridge;
...
public class DefaultRxHttpClient implements RxHttpClient {
    ...
    public <T> Maybe<T> prepare(Request request, Supplier<? extends AsyncHandler<T>> handlerSupplier) {
        ...
        return Maybe.create(emitter -> {
            ...
            emitter.setDisposable(Disposable.fromFuture(responseFuture));
        });
    }
