...
public class MiscUtilTest {
    ...
    public void testGetDefaultIntegerValue() {
        ...
        Assert.assertEquals(MiscUtil.getIntValue(MY_SPECIAL_INT_PROPERTY, MY_SPECIAL_INT_DEFAULT_VALUE), MY_SPECIAL_INT_DEFAULT_VALUE);
        // Setup up a mock of a asynchttpclient.properties that initially is
        // empty
        Properties properties = new Properties();
        AsyncImplHelperMock asyncImplHelperMock = new AsyncImplHelperMock(properties);
        ...
        // Set a corrupt system property
        System.setProperty(MY_SPECIAL_INT_PROPERTY, "corrupt property");
        // Assert that even though values set in asynchttpclient.properties and
        // system property is corrupt the default value is
        // returned
        Assert.assertEquals(MiscUtil.getIntValue(MY_SPECIAL_INT_PROPERTY, MY_SPECIAL_INT_DEFAULT_VALUE), MY_SPECIAL_INT_DEFAULT_VALUE);
        System.clearProperty(MY_SPECIAL_INT_PROPERTY);
    }
