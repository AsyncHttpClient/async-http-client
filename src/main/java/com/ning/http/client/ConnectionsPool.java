...
public interface ConnectionsPool<U, V> {
     ...
     */
    public boolean addConnection(U uri, V connection);
     ...
     * @return the connection associated with the uri
     */
    public V removeConnection(U uri);
     ...
     */
    public boolean removeAllConnections(V connection);

    /**
     * Return true if a connection can be cached. A implementation can decide based on some rules to allow caching
     * Calling this method is equivalent of checking the returned value of {@link ConnectionsPool#addConnection(Object, Object)}
