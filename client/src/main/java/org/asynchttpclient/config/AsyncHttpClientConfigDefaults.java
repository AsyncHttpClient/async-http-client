...
public final class AsyncHttpClientConfigDefaults {
    ...
    public static final String HTTP_CLIENT_CODEC_ALLOW_PARTIAL_CHUNKS = "httpClientCodecAllowPartialChunks";
    ...
    public static boolean defaultHttpClientAllowPartialChunks() {
        return AsyncHttpClientConfigHelper.getAsyncHttpClientConfig().getBoolean(ASYNC_CLIENT_CONFIG_ROOT + HTTP_CLIENT_CODEC_ALLOW_PARTIAL_CHUNKS);
    }
