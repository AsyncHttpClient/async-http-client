...
public class UriParserTest {
    ...
    public void testUrlFragment() {
        ...
        assertEquals(parser.scheme, "https", "Scheme should be taken from the context when prasing a URL fragment");
    ...
    @Test
    public void testReltiveURLWithDots() {
        Uri context = new Uri("https", null, "example.com", 80, "/path", "q=2");
        UriParser parser = new UriParser();
    ...
    @Test
    public void testReltiveURLWithTwoEmbeddedDots() {
        Uri context = new Uri("https", null, "example.com", 80, "/path", "q=2");
        UriParser parser = new UriParser();
        parser.parse(context, "./relative/../url");
        assertEquals(parser.host, "example.com", "Host should be taken from the context when parsing a relative URL");
    ...
    @Test
    public void testReltiveURLWithTwoTrailingDots() {
        Uri context = new Uri("https", null, "example.com", 80, "/path", "q=2");
        UriParser parser = new UriParser();
        parser.parse(context, "./relative/url/..");
        assertEquals(parser.host, "example.com", "Host should be taken from the context when parsing a relative URL");
    ...
    @Test
    public void testReltiveURLWithOneTrailingDot() {
        Uri context = new Uri("https", null, "example.com", 80, "/path", "q=2");
        UriParser parser = new UriParser();
        parser.parse(context, "./relative/url/.");
        assertEquals(parser.host, "example.com", "Host should be taken from the context when parsing a relative URL");
