...
public final class AsyncHttpClientConfigDefaults {
    ...
    public static final String MAX_REDIRECT_CONFIG = "maxRedirects";
    ...
    public static int defaultMaxRedirects() {
        return AsyncHttpClientConfigHelper.getAsyncHttpClientConfig().getInt(ASYNC_CLIENT_CONFIG_ROOT + MAX_REDIRECT_CONFIG);
    }
