 ...
 * all doing nothing except returning {@link org.asynchttpclient.handler.AsyncHandler.STATE#CONTINUE}
 *
...
public abstract class AsyncCompletionHandler<T> implements AsyncHandler<T>, ProgressAsyncHandler<T> {
     ...
     *
     * @return a {@link org.asynchttpclient.handler.AsyncHandler.STATE} telling to CONTINUE or ABORT the current processing.
     */
