...
public class DefaultAsyncHttpClientConfig implements AsyncHttpClientConfig {
    ...
    public static class Builder {
        ...
        /**
         * Extra restrictions on a redirect this client would otherwise follow; needs
         * {@link #setFollowRedirect(boolean)}. Unlike {@link #setLoadBalance(LoadBalance)}, {@code null} here
         * re-reads the configured default - {@link RedirectPolicy} has no {@code DEFAULT} constant.
         *
